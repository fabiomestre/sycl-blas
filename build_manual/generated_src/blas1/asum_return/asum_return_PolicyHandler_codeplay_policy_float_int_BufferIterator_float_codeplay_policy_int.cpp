 ...
 *
 * @param Executor<PolicyHandler<PolicyHandler<codeplay_policy>>> ex
 * @param _vx  VectorView
 * @param _incx Increment in X axis
 */
template
    typename ValueType<BufferIterator<float,codeplay_policy>>::type _asum(Executor<PolicyHandler<codeplay_policy>> &ex,
                                                    int _N,
