 ...
 */
template typename Executor<PolicyHandler<codeplay_policy>>::policy_t::event_t _gemv(
    Executor<PolicyHandler<codeplay_policy>>& ex, char _trans, int _M, int _N,
    float _alpha, BufferIterator<float,codeplay_policy> _mA, int _lda,
    BufferIterator<float,codeplay_policy> _vx, int _incx, float _beta,
    BufferIterator<float,codeplay_policy> _vy, int _incy);
