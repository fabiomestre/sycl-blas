...
namespace reference_blas {
    ...
    struct BlasSystemFunction {
        template<typename floatfn_t, typename doublefn_t, typename complexfloatfn_t, typename complexdoublefn_t>
        static floatfn_t get(floatfn_t ffn, doublefn_t, complexfloatfn_t, complexdoublefn_t) noexcept
        {
            return ffn;
        }
    };
    ...
    struct BlasSystemFunction<double> {
        template<typename floatfn_t, typename doublefn_t, typename complexfloatfn_t, typename complexdoublefn_t>
        static doublefn_t get(floatfn_t, doublefn_t dfn, complexfloatfn_t, complexdoublefn_t) noexcept
        {
            return dfn;
        }
    };
    ...
    template<>
    struct BlasSystemFunction<cl::sycl::ext::oneapi::experimental::complex<float>> {
        template<typename floatfn_t, typename doublefn_t, typename complexfloatfn_t, typename complexdoublefn_t>
        static complexfloatfn_t get(floatfn_t, doublefn_t, complexfloatfn_t cffn, complexdoublefn_t) noexcept
        {
            return cffn;
        }
    };
    ...
    template<>
    struct BlasSystemFunction<cl::sycl::ext::oneapi::experimental::complex<double>> {
        template<typename floatfn_t, typename doublefn_t, typename complexfloatfn_t, typename complexdoublefn_t>
        static complexfloatfn_t get(floatfn_t, doublefn_t, complexfloatfn_t, complexdoublefn_t cdfn) noexcept
        {
            return cdfn;
        }
    };

    template<typename scalar_t, typename floatfn_t, typename doublefn_t, typename complexfloatfn_t, typename complexdoublefn_t>
    auto blas_system_function(floatfn_t ffn, doublefn_t dfn, complexfloatfn_t cffn, complexdoublefn_t cdfn)
    -> decltype(BlasSystemFunction<scalar_t>::get(ffn, dfn, cffn, cdfn))
    {
        return BlasSystemFunction<scalar_t>::get(ffn, dfn, cffn, cdfn);
    }
...
void axpy(const int n, scalar_t alpha, const scalar_t x[], const int incX,
    ...
    auto func = blas_system_function<scalar_t>(&cblas_saxpy, &cblas_daxpy, &cblas_caxpy, &cblas_zaxpy);
    if constexpr (std::is_same_v<scalar_t, cl::sycl::ext::oneapi::experimental::complex<float>> || std::is_same_v<scalar_t, cl::sycl::ext::oneapi::experimental::complex<double>>) {
        func(n, static_cast<void*>(&alpha), x, incX, y, incY);
    }
    else {
